...
var Rocker = (function () {
     ...
     */
    p.init = function (moveBg, moveFlag, dealKeyFunc, dealKeyTarget) {
        this.keys = [0, 0];
        this.mouseX = -1;
        this.mouseY = -1;
        ...
        this.moveFlagCheckRec = new egret.Rectangle(0, 0, StageUtils.stageW * 0.5, StageUtils.stageH);
        ...
        StageUtils.stage.addEventListener(egret.TouchEvent.TOUCH_END, this.leaveStateEvent, this);
        StageUtils.stage.addEventListener(egret.TouchEvent.TOUCH_MOVE, this.heroMoveEvent, this);
        //键盘控制
     ...
     * @param e
     */
    p.runMove = function (stageX, stageY) {
        if (!this.isMoveing) {
            return;
        }
        ...
        if (this.moveFlagRec.contains(this.mouseX, this.mouseY)) {
            ...
            var radian = MathUtils.getRadian2(this.moveFlagX, this.moveFlagY, this.mouseX, this.mouseY);
     ...
     * 开启检测
     */
    p.startCheckKey = function () {
        if (!this.checkKeying) {
            this.checkKeying = true;
            TimerManager.doFrame(1, 0, this.delKeys, this);
        }
    };
    /**
     * 停止检测
     */
    p.stopCheckKey = function () {
        this.keys[0] = 0;
        this.keys[1] = 0;
        if (this.checkKeying) {
            TimerManager.remove(this.delKeys, this);
