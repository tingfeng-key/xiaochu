...
class GameSence extends egret.DisplayObjectContainer {
    private _topBg: egret.Bitmap;//顶部背景
    private _grid: Grid;//格子
    private _scoreBg: egret.Bitmap;//分数背景
    private _scoreNumber: Score;//分数
    private _border1: egret.Bitmap;
    private _border2: egret.Bitmap;
    private _buttom: egret.Bitmap;
    private _timerBg: egret.Bitmap;
    public _timer:egret.Bitmap;
    //构造函数
    public constructor(){
        super();
    }
     ...
     * @constructor
     */
    public DecTimer(val: number, status: boolean = false): void{
        this._timer.alpha = 1;
     ...
     * @constructor
     */
    public DecTimers(status: boolean = false): void{
     ...
     * 单列模式
     */
    public static _interval:GameSence;
    public static get interval(): GameSence {
